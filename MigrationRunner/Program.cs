...
// Find appsettings.json - try multiple possible locations
var possiblePaths = new[]
{
    Path.Combine(Directory.GetCurrentDirectory(), "..", "backend", "Milo.API", "appsettings.json"),
    Path.Combine("..", "backend", "Milo.API", "appsettings.json"),
    Path.GetFullPath(Path.Combine("..", "..", "backend", "Milo.API", "appsettings.json")),
    @"c:\milo\backend\Milo.API\appsettings.json"
};
...
{
    Console.WriteLine($"Error: appsettings.json not found. Tried:");
    foreach (var path in possiblePaths)
    {
