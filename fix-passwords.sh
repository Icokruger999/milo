#!/bin/bash
# Fix both RDS and SMTP passwords on EC2
...
echo "✅ appsettings.json updated with correct passwords:"
echo "   RDS Password: Stacey1122 (without @)"
echo "   SMTP Password: Stacey@1122 (with @)"
echo ""
